...
<div class="front abooked">
        ...
        <!-- <li><a href="asignedin.php">Back</a></li> -->
          ...
          echo($_SESSION['adminname']);?> </button>
           <div class="dropdown-content">
            ...
            <a href="bookeddb.php">Active events</a>
      ...
      <div class="abooktb">
        <h1>COMPLETED BOOKED DETAILS</h1>
    <table border="3">
    <th>C_id</th>
    <th>Pt_id</th>
    <th>U_name</th>
...
if($retval!=0){
    ...
    while(($result=mysqli_fetch_assoc($retval))){
        ...
        <td>".$result['price']."</td>
        <td> 
            <form action='markEactive.php' class='markEactive' method='post'>
                <button type='submit' name='markEactive' value='".$result['C_id']."'>Mark Active</button>
            </form>
        </td>
        </tr>";}
    }
