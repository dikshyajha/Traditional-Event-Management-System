...
$sqlitable="CREATE TABLE  if not exists customer
        (C_id int NOT NULL AUTO_INCREMENT,u_id int,username varchar(20),name varchar(15), email varchar(30),number varchar(10) ,address varchar(20),date DATE NOT NULL,event varchar(15),venue varchar(30),priest varchar(20),price int,pt_id varchar(30),status int(1) DEFAULT 1,PRIMARY KEY(C_id))";
    $table=mysqli_query($con,$sqlitable);
    if (!$table)
