...
<html lang="en">
  ...
  <body class="pbody" background="photo\aboutBg3.jpg">
  <div class="navbar">
       <a href="signedin.php"> <img src="photo/logo.png" class="logo" /></a>
       <ul>
       <li><a style="color:black; font-size: large; font-weight:600;" href="about.php">About Us</a></li>
            <li ><a style="color:black; font-size: large; font-weight:600;" href="gallery.php"> Gallery</a></li>
            <li  ><a style="color:black; font-size: large; font-weight:600;"href="venue.php"> Venue</a></li>
            <li ><a style="color:black; font-size: large; font-weight:600;" href="priest.php"> Priest</a></li>
            <li ><a style="color:black; font-size: large; font-weight:600;" href="service.php">Service</a></li>
            <li ><a style="color:black; font-size: large; font-weight:600;" href="contact.php">Contact Us</a></li>
       <li class="last"><div class="dropdown"> <button class="dropbtn"><img src="photo/uimage.png" height=20px><?php
          echo($_SESSION['uname']);?> </button>
           <div class="dropdown-content">
            <a  style="color:black; font-size: large;" href="logout.php">Logout</a>
            <a  style="color:black; font-size: large;" href="user.php">My profile</a>
            </div>
</div></a></li>
        </ul>
      </div>
