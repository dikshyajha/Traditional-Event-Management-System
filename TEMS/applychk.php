...
// $sql="INSERT INTO customer(username,name,email,number,address,date,event,venue,priest,price) VALUES ('$username','$name','$email','$number','$address','$date','$event','$venue','$priest','$total')";
