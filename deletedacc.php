        ...
        <!-- <li><a href="asignedin.php">Back</a></li> -->
          ...
          echo($_SESSION['adminname']);?> </button>
           <div class="dropdown-content">
            ...
            <a href="userdb.php"> View Active Accounts</a>
            </div>
</div></a></li>
        </ul>
      </div>
...
if($retval!=0){
    ...
    while(($result=mysqli_fetch_assoc($retval))){
        ...
        <td>".$result['gender']."</td>
        <td> 
                <form action='restoreuser.php' class='restoreuser' method='post'>
                        <button id='go1' type='submit' name='restoreuser' value='".$result['R_id']."'>Restore account</button>
                </form>
                </td>
        </tr>";}
    }
